...
class MoviePopularNotifier extends StateNotifier<MovieDiscover> {
  MoviePopularNotifier() : super(const MovieDiscover()) {
    _initGet();
  }
  ...
  _initGet([int? initPage]) async {
    ...
    final response = await movieDataSource.loadMoviePopularList(page);
    if (response == null) {
