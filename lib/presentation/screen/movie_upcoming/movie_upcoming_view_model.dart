...
class MovieUpcomingNotifier extends StateNotifier<MovieDiscover> {
  MovieUpcomingNotifier() : super(const MovieDiscover()) {
    _initGet();
  }
  ...
  _initGet([int? initPage]) async {
    ...
    final response = await movieDataSource.loadMovieUpcomingList(page);
    if (response == null) {
