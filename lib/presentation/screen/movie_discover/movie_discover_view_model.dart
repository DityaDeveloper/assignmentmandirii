...
class MovieDiscoverNotifier extends StateNotifier<MovieDiscover> {
  MovieDiscoverNotifier() : super(const MovieDiscover()) {
    _initGet();
  }
  ...
  _initGet([int? initPage]) async {
    ...
    final response = await movieDataSource.loadMovieDiscoverList(page);
    if (response == null) {
